...
const NavBar: React.FC<NavBarProps> = ({}) => {
    ...
    return (
        <div className='relative flex justify-center z-50'>
            <div className={`absolute flex w-screen min-w-[768px] max-w-[1200px]`}>
                ...
                <div className={!nav ? 'hidden' : 'absolute w-screen h-screen'}>
                    <ul className={!nav ? 'hidden' : 'absolute h-[100%] px-10 space-y-[-1rem] pt-16 bg-[#AB94FF] w-screen z-10'}>
                        <li>
                    ...
                    <div className="m-auto mr-0 space-y-3 lg:space-x-0 lg:space-y-3 block lg:block w-full justify-center">
                        ...
                        <button type='button' className='mx-auto relative icon-style bg-[#D1C5FF] hover:bg-[#FF60E6] flex text-black
                            ...
                            <p className="absolute left-0 right-0 mx-auto mt-[0.15rem] ml-[-12.5rem]"> <EnvelopeIcon className="icons mx-auto w-[1.2rem] lg:w-6 lg:left-8 " /></p>
