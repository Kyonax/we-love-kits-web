                ...
                <div className='block'>
                    <div className="flex w-full">
                        <motion.div
                            ...
                            className="w-full lg:w-3/5 block text-5xl lg:text-6xl font-light text-black text-left" ref={refText}>
                    ...
                    <div className='flex justify-left'>
                        <div className='w-11/12 flex'>
                            <motion.div
                                ...
                                className='w-1/3 m-auto p-[4rem] pt-8 lg:p-[6rem] lg:pt-16 pl-0 lg:pl-0 opacity-80' ref={refLogoFirst}>
                                <LazyLoadImage
                            ...
                            <motion.div
                                ...
                                className='w-1/3 m-auto p-[4rem] pt-8 lg:p-[6rem] lg:pt-16 pl-0 lg:pl-0 opacity-80' ref={refLogoSecond}>
                                <LazyLoadImage
                                    alt='Logo Nutresa'
                                    src={LogoNutresa}
                                />
                            ...
                            <motion.div
                                ...
                                className='w-1/3 m-auto p-[4rem] pt-8 lg:p-[6rem] lg:pt-16 pl-0 lg:pl-0 opacity-80' ref={refLogoThird}>
                                <LazyLoadImage
                                    alt='Logo Bancolombia'
                                    src={LogoBancolombia}
                                />
