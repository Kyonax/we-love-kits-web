...
const FourthSection: React.FC<FourthSectionProps> = ({}) => {
    return (
        <div className='m-auto w-screen flex justify-center bg-white'>
            <div className='m-auto px-5 mt-[5rem] block lg:flex w-screen min-w-[0px] max-w-[768px]'>
                ...
                <div className="w-full lg:w-6/12 block py-10 px-0 text-4xl sm:text-5xl text-black font-light">
                    ...
                    <p>DE ARTE</p>
                    <p className="px-[11rem] sm:px-[33rem] sm:pl-0 lg:px-[20.5rem] lg:pl-0 mt-4 pl-0"><LazyLoadImage src={HeartText} /></p>
                ...
                <div className="w-full lg:w-6/12 lg:pr-5 pl-0 font-bold text-[11px] sm:text-[14px]">
                    <div style={{ backgroundImage: `url(${KitBienvenida})` }} className="group hover:cursor-pointer relative w-full lg:m-6 h-[15rem] lg:h-[20rem] bg-cover bg-center rounded-2xl">
                    ...
                    <div style={{ backgroundImage: `url(${KitEventos})` }} className="group hover:cursor-pointer relative w-full my-6 lg:m-6 h-[15rem] lg:h-[20rem] bg-cover bg-center rounded-2xl">
                            <div className='absolute flex w-full justify-center bottom-8 hover:cursor-pointer'>
                                <button className='py-2 px-10 bg-black border-none text-white hover:bg-black hover:text-white rounded-full'>
                                    <p className="group-hover:text-[#FFF384]
                                                  easy-in group-hover:easy-out duration-300 transition-opacity">
                    ...
                    <div style={{ backgroundImage: `url(${KitProyectos})` }} className="group hover:cursor-pointer relative w-full my-6 lg:m-6 h-[15rem] lg:h-[20rem] bg-cover bg-center rounded-2xl">
                            <div className='absolute flex w-full justify-center bottom-8 hover:cursor-pointer'>
                                <button className='py-2 px-10 bg-black border-none text-white hover:bg-black hover:text-white rounded-full'>
                                    <p className="group-hover:text-[#FFF384]
                                                  easy-in group-hover:easy-out duration-300 transition-opacity">
                    ...
                    <div style={{ backgroundImage: `url(${KitReconocimiento})` }} className="group hover:cursor-pointer relative w-full my-6 lg:m-6 h-[15rem] lg:h-[20rem] bg-cover bg-center rounded-2xl">
                            <div className='absolute flex w-full justify-center bottom-8 hover:cursor-pointer'>
                                <button className='py-2 px-10 bg-black border-none text-white hover:bg-black hover:text-white rounded-full'>
                                    <p className="group-hover:text-[#FFF384]
                                                  easy-in group-hover:easy-out duration-300 transition-opacity">
