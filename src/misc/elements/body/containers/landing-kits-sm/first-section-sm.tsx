        ...
        <div style={{backgroundColor: bannerColor}} className="relative flex justify-center mt-0 transition-all easy-in delay-300">
            <div className="absolute text-center text-white flex w-full h-full">
                <div className="w-full h-full relative m-auto mt-[6rem] flex">
                    <div className="w-full h-full mx-auto content text-center min-w-[0px] max-w-[768px] transition easy-in-out duration-700 px-10">
                        ...
                        <h1 className={contentText === "KITS" ? 'opacity-100 transition-every px-[50px]' : 'opacity-0 transition-every px-[50px]'}>
                            <LazyLoadImage src={KITS_LETTER} />
                        </h1>

                        <h1 className={contentText === "KITS" ? 'opacity-100 transition-every text-stroke px-[50px]' : 'opacity-0 transition-every text-stroke px-[50px]'}>
                        ...
                        <h1 className={contentText === "USABLES" ? 'opacity-100 transition-every px-[50px] sm:px-[80px]' : 'opacity-0 transition-every px-[50px] sm:px-[80px]'}>
                            <LazyLoadImage src={USABLES_LETTER} />
                        </h1>
                        <h1 className={contentText === "USABLES" ? 'opacity-100 transition-every text-stroke px-[50px] sm:px-[80px]' : 'opacity-0 transition-every text-stroke px-[50px] sm:px-[80px]'}>
            ...
            <div className="m-auto max-w-[768px] min-w-[0px]">
