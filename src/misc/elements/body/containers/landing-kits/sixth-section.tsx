...
const SixthSection: React.FC<SixthSectionProps> = ({}) => {
    ...
    return (
        <div className='w-screen pb-[10rem] flex justify-center bg-white'>

            <div className="flex absolute w-full h-full">                
                <div className="m-auto flex mt-[8rem] bg-[#7DE2FF] w-full h-[25rem]">
                    <div className="m-auto flex w-screen min-w-[1200px] max-w-[1200px]">
                    <div className="w-5/12 ml-0 m-auto flex p-16 pt-7 pl-0">
            ...
            <motion.div
                ...
                className=' t-[10rem] m-auto flex w-screen min-w-[1200px] max-w-[1200px]' ref={refBlock}>
                <motion.div
                    ...
                    <div className="w-6/12 h-[50rem] relative flex z-10">
                        <motion.div
                            variants={{
                                hidden: {opacity: 0},
                                visible: {opacity: 1}
                    ...
                    <div className="w-6/12 bg-white flex rounded-2xl border border-[#002538] p-16 text-[#002538] text-[1.2rem] z-10">
