...
function App() {
    ...
    return (
        <div className='bg-black body-parallax overflow-hidden container-parallax-1'>
            ...
            <Routes> <Route path='/testing-we-love-kits-v46-24fps' element={firstSectionRender()} /> </Routes>

            <div className='text-white'>
                <div>
                    <Routes> <Route path='/testing-we-love-kits-v46-24fps' element={landingKitsRender()} /> </Routes>
                </div>
            </div>
