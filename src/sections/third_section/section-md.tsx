...
const ThirdSection = () => {
    ...
    return (
        <div className='w-screen flex justify-center bg-white'>
            ...
            <div id="to-blur" className='m-auto px-2 mt-[8rem] lg:mt-[15rem] w-full min-w-[768px] max-w-[1200px]'>
                <motion.div
                   variants={{
                ...
                <div className='w-full mt-16 font-bold'>
                    <div className="blockjk lg:flex mb-4">
                        ...
                        <div className="flex h-[25rem] lg:w-2/4">
                            <motion.div
                                ...
                                className="group container-card hover:cursor-pointer relative w-1/2 lg:w-1/2 mr-2 bg-cover bg-center rounded-2xl h-full" ref={refBlockFirst}>
                            ...
                            <motion.div
                                ...
                                className="container-card group hover:cursor-pointer relative w-1/2 lg:w-1/2 ml-2 lg:mx-2 bg-cover bg-center rounded-2xl h-full" ref={refBlockSecond}>
                        ...
                        <motion.div
                             ...
                             className="container-card group hover:cursor-pointer relative w-full lg:w-2/4 mt-4 lg:ml-2 lg:mt-0 bg-cover bg-center rounded-2xl h-[25rem]" ref={refBlockThird}>
                    ...
                    <div className="block lg:flex mb-4">
                        <motion.div
                            ...
                            className="container-card group hover:cursor-pointer relative w-full lg:w-2/4 lg:mr-2 bg-cover bg-center rounded-2xl h-[25rem]" ref={refBlockFourth}>
                            <div className="background" style={{width: mediumImageSizeWidth.sizeResponsive.width, height: mediumImageSizeWidth.sizeResponsive.height}}>
                        ...
                        <div className='flex h-[25rem] lg:w-2/4 mt-4 lg:mt-0'>
                            <motion.div
                                ...
                                className="container-card group hover:cursor-pointer relative flex w-1/2 mr-2 lg:mx-2 bg-cover bg-center rounded-2xl h-full" ref={refBlockFifth}>
                            ...
                            <motion.div
                                ...
                                className="container-card group hover:cursor-pointer relative w-1/2 ml-2 bg-cover bg-center rounded-2xl h-full" ref={refBlockSixth}>
                            <div className="background" style={{width: smallImageSize.sizeResponsive.width, height: smallImageSize.sizeResponsive.height}}>
                    ...
                    <div className="block lg:flex mb-4">
                        <motion.div
                            ...
                            className="container-card group hover:cursor-pointer relative w-full lg:w-1/4 lg:mr-2 mt-4 lg:mt-0 bg-cover bg-center rounded-2xl h-[25rem]" ref={refBlockSeventh}>
                        ...
                        <div className="flex h-[25rem] lg:w-3/4 mt-4 lg:mt-0">
                            <motion.div
                                ...
                                className="container-card group hover:cursor-pointer relative flex w-1/2 lg:w-2/3 mr-2 lg:mx-2 bg-cover bg-center rounded-2xl h-full" ref={refBlockEight}>
                            <div className="background" style={{width: smallImageSizeWidth.sizeResponsive.width, height: smallImageSizeWidth.sizeResponsive.height}}>
                            ...
                            <motion.div
                                ...
                                className="container-card group hover:cursor-pointer relative w-1/2 lg:w-1/3 ml-2 bg-cover bg-center rounded-2xl h-full" ref={refBlockNineth}>
                            <div className="background" style={{width: largeImageSize.sizeResponsive.width, height: largeImageSize.sizeResponsive.height}}>
