...
const ThirdSection = () => {
    ...
    return (
        <div className='w-screen flex justify-center bg-white'>
            ...
            <div id="to-blur" className='m-auto px-2 mt-[2rem] w-full min-w-[0px] max-w-[768px]'>
                <motion.div
                   variants={{
                ...
                <div className='w-full mt-10 font-bold'>
                    <div className="blockjk lg:flex mb-4 text-[11px] sm:text-[14px]">
                        ...
                        <div className="block sm:flex lg:w-2/4">
                            ...
                            className="container-card group h-[20rem] hover:cursor-pointer relative w-full lg:w-1/2 bg-cover bg-center rounded-2xl" ref={refBlockFirst}>
                            ...
                            onClick={event => {setIsModal(true); setWhichCard(2)}}
                                className="container-card group h-[20rem] hover:cursor-pointer relative w-full lg:w-1/2 mt-4 sm:mt-0 sm:ml-4 lg:mx-2 bg-cover bg-center rounded-2xl" ref={refBlockSecond}>
                        ...
                        <motion.div
                            ...
                            className="container-card group hover:cursor-pointer relative w-full lg:w-2/4 mt-4 lg:ml-2 lg:mt-0 bg-cover bg-center rounded-2xl h-[20rem]" ref={refBlockThird}>
                    ...
                    <div className="block lg:flex mb-4 text-[11px] sm:text-[14px]">
                        <motion.div
                            ...
                            className="container-card group hover:cursor-pointer relative w-full lg:w-2/4 lg:mr-2 bg-cover bg-center rounded-2xl h-[20rem]" ref={refBlockFourth}>
                            <div className="background" style={{width: mediumImageSizeWidth.sizeResponsive.width, height: mediumImageSizeWidth.sizeResponsive.height}}>
                        ...
                        <div className='block sm:flex lg:w-2/4 mt-4 lg:mt-0'>
                            ...
                            onClick={event => {setIsModal(true); setWhichCard(5)}}
                                className="container-card group hover:cursor-pointer relative flex w-full mr-2 lg:mx-2 bg-cover bg-center rounded-2xl h-[20rem]" ref={refBlockFifth}>
                            ...
                            onClick={event => {setIsModal(true); setWhichCard(6)}}
                                 className="container-card group hover:cursor-pointer relative w-full mt-4 sm:mt-0 sm:ml-2 bg-cover bg-center rounded-2xl h-[20rem]" ref={refBlockSixth}>
                            <div className="background" style={{width: smallImageSize.sizeResponsive.width, height: smallImageSize.sizeResponsive.height}}>
                    ...
                    <div className="block lg:flex mb-4 text-[11px] sm:text-[14px]">
                        <motion.div
                            ...
                            className="container-card group hover:cursor-pointer relative w-full lg:w-1/4 lg:mr-2 mt-4 lg:mt-0 bg-cover bg-center rounded-2xl h-[20rem]" ref={refBlockSeventh}>
                            <div className="background" style={{width: smallImageSizeWidth.sizeResponsive.width, height: smallImageSizeWidth.sizeResponsive.height}}>
                                <LoadImage alt="Buttons Component Mockup" w={smallImageSizeWidth.sizeResponsive.width}
                                           h={smallImageSizeWidth.sizeResponsive.height} instantLoad={false} image={Images['button_one']}/>
                            </div>
                            <div className='absolute flex w-full justify-center bottom-8'>
                                <button className='py-2 px-10 bg-black border-none text-white hover:bg-black hover:text-white rounded-full'>
                                    <p className="group-hover:text-[#FFF384]
                        ...
                        <div className="block sm:flex lg:w-3/4 mt-4 lg:mt-0">
                            ...
                            onClick={event => {setIsModal(true); setWhichCard(8)}}
                                className="container-card group hover:cursor-pointer relative flex w-full lg:w-2/3 mr-2 lg:mx-2 bg-cover bg-center rounded-2xl h-[20rem]" ref={refBlockEight}>
                            <div className="background" style={{width: smallImageSizeWidth.sizeResponsive.width, height: smallImageSizeWidth.sizeResponsive.height}}>
                            ...
                            onClick={event => {setIsModal(true); setWhichCard(9)}}
                                className="container-card group hover:cursor-pointer relative w-full lg:w-1/3 mt-4 sm:mt-0 sm:ml-2 bg-cover bg-center rounded-2xl h-[20rem]" ref={refBlockNineth}>
                            <div className="background" style={{width: largeImageSize.sizeResponsive.width, height: largeImageSize.sizeResponsive.height}}>
