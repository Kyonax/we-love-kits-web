...
const FourthSection = () => {
    ...
    const textControls = useAnimation(), heartsControls = useAnimation(), girlControls = useAnimation(),
          ...
          cardFourthControls = useAnimation(), modalControls = useAnimation();
    ...
    }, [isInViewText, isInViewHearts, isInViewGirl, isInViewCardOne, isInViewCardTwo, isInViewCardThree, isInViewCardFourth, isModal])
            ...
            <div id="to-blur" className='m-auto mt-[10rem] flex w-screen min-w-[1200px] max-w-[1200px]'>
                <div className="w-4/12 block py-10 px-0 text-6xl text-black font-light">
                    ...
                    <motion.p
                        ...
                        className="px-[10rem] mt-4 pl-0" ref={refHearts}>
                        <LazyLoadImage src={HeartText} />
                    </motion.p>
                    <motion.p
                        variants={{
                        ...
                        className="px-[10rem] mt-6 pl-0" ref={refGirl}>
                        <LazyLoadImage src={HeartGirl} />
                    </motion.p>
                </div>
